...
export type RouteSearchFilterInput = {
    bus: Scalars['Boolean'];
    ferry: Scalars['Boolean'];
    flight: Scalars['Boolean'];
...
export const SearchCityDocument = {
    "kind": "Document", "definitions": [{
        "kind": "OperationDefinition",
        "operation": "query",
        "name": {"kind": "Name", "value": "SearchCity"},
        "variableDefinitions": [{
...
} as unknown as DocumentNode<SearchCityQuery, SearchCityQueryVariables>;
export const FindAllRoutesDocument = {
    "kind": "Document", "definitions": [{
        "kind": "OperationDefinition",
        "operation": "query",
        "name": {"kind": "Name", "value": "FindAllRoutes"},
        "variableDefinitions": [{
            "kind": "VariableDefinition",
            ...
            "type": {
                "kind": "NonNullType",
                "type": {"kind": "NamedType", "name": {"kind": "Name", "value": "PointType"}}
            }
        }, {
            "kind": "VariableDefinition",
            ...
            "type": {
                "kind": "NonNullType",
                "type": {"kind": "NamedType", "name": {"kind": "Name", "value": "RouteSearchFilterInput"}}
            }
        }],
        "selectionSet": {
            "kind": "SelectionSet", "selections": [{
                ...
                "selectionSet": {
                    ...
                    "selections": [{
                        "kind": "Field",
                        "name": {"kind": "Name", "value": "destinationName"}
                    }, {"kind": "Field", "name": {"kind": "Name", "value": "destinationId"}}, {
                        "kind": "Field",
                        "name": {"kind": "Name", "value": "latitude"}
                    }, {"kind": "Field", "name": {"kind": "Name", "value": "longitude"}}, {
                        "kind": "Field", "name": {"kind": "Name", "value": "routes"}, "selectionSet": {
                            "kind": "SelectionSet",
                            "selections": [{
                                "kind": "Field",
                                ...
                                "kind": "Field",
                                "name": {"kind": "Name", "value": "durationTotal"}
                            }, {
                                "kind": "Field",
                                "name": {"kind": "Name", "value": "durationMinutes"}
                            }, {"kind": "Field", "name": {"kind": "Name", "value": "durationHours"}}, {
                                "kind": "Field",
                                "name": {"kind": "Name", "value": "lineDistance"}
                            }]
                        }
                    }, {"kind": "Field", "name": {"kind": "Name", "value": "durationAverage"}}, {
                        "kind": "Field",
                        "name": {"kind": "Name", "value": "lineDistanceAverage"}
                    }]
                }
            }]
        }
    }]
} as unknown as DocumentNode<FindAllRoutesQuery, FindAllRoutesQueryVariables>;
export const FindCityByIdDocument = {
    "kind": "Document",
    "definitions": [{
        "kind": "OperationDefinition",
        "operation": "query",
        "name": {"kind": "Name", "value": "FindCityById"},
        "variableDefinitions": [{
            "kind": "VariableDefinition",
...
} as unknown as DocumentNode<FindCityByIdQuery, FindCityByIdQueryVariables>;
export const FindAllCitiesFromAssociatedTransitDocument = {
    "kind": "Document", "definitions": [{
        "kind": "OperationDefinition",
        "operation": "query",
        "name": {"kind": "Name", "value": "FindAllCitiesFromAssociatedTransit"},
        "variableDefinitions": [{
            "kind": "VariableDefinition",
            "variable": {"kind": "Variable", "name": {"kind": "Name", "value": "id"}},
            "type": {"kind": "NonNullType", "type": {"kind": "NamedType", "name": {"kind": "Name", "value": "String"}}}
            ...
            "kind": "VariableDefinition",
            "variable": {"kind": "Variable", "name": {"kind": "Name", "value": "transitType"}},
            "type": {
                "kind": "NonNullType",
                "type": {"kind": "NamedType", "name": {"kind": "Name", "value": "StationType"}}
            }
        }, {
            "kind": "VariableDefinition",
        ...
        "selectionSet": {
            ...
            "selections": [{
                ...
                "arguments": [{
                    "kind": "Argument",
                    "name": {"kind": "Name", "value": "transitSearchInput"},
                    "value": {
                        "kind": "ObjectValue",
                        "fields": [{
                            "kind": "ObjectField",
                            ...
                            "kind": "ObjectField",
                            "name": {"kind": "Name", "value": "transitType"},
                            "value": {"kind": "Variable", "name": {"kind": "Name", "value": "transitType"}}
                        }, {
                            "kind": "ObjectField",
                            "name": {"kind": "Name", "value": "name"},
...
} as unknown as DocumentNode<FindAllCitiesFromAssociatedTransitQuery, FindAllCitiesFromAssociatedTransitQueryVariables>;